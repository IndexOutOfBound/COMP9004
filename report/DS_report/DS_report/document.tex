...
We aim to accomplish two parts. The first part concentrates on replicating the original model provided by NetLogo. The basic attributes we applied to contribute to wealth distribution list blow.
\begin{multicols}{2}
  \begin{itemize}
